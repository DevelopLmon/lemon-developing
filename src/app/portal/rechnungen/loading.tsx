export default function Loading() {
  return (
    <div className="p-8 animate-pulse">
      <div className="h-9 w-36 rounded-xl bg-white/8 mb-2" />
      <div className="h-4 w-44 rounded-lg bg-white/5 mb-8" />
      <div className="rounded-2xl overflow-hidden" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="px-5 py-3.5 border-b border-white/8 flex gap-8">
          {[120, 120, 80, 80, 80].map((w, i) => (
        ...
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="flex items-center gap-8 px-5 py-4 border-b border-white/5">
            <div className="h-4 w-28 rounded-md bg-white/8 font-mono" />
